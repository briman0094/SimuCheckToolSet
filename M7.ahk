...
Loop                                  
{
    ...
    ; Throttle
    AxisToKeysNotches(JoystickNumber, "JoyZ", 21, "{a down}{Sleep 100}{a up}{Sleep 10}", "{d down}{Sleep 100}{d up}{Sleep 10}", "{a down}{Sleep 250}{a up}{Sleep 10}", "{d down}{Sleep 250}{d up}{Sleep 10}")
